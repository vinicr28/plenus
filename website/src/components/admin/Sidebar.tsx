...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-64 bg-[#1a1a1a] h-full shrink-0">
      {/* Logo */}
      <div className="flex items-center justify-center h-16 px-4 border-b border-white/10">
        <Link href="/admin/dashboard" className="inline-flex items-center">
          ...
          <span className="ml-1 text-xs font-light tracking-widest text-white/60">
            OBRAS
          </span>
        </Link>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        ...
        <Link
          href="/"
          className="flex items-center gap-3 px-4 py-3 w-full rounded-lg text-gray-400 hover:bg-white/5 hover:text-white transition-colors mt-1"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
