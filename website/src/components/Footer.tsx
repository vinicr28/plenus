            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-white/60 text-sm hover:text-white transition-colors duration-200"
                >
                  <svg
                  ...
                  R. Alm. Tamandaré, 365 - Cidade Nova II, Indaiatuba - SP
                </a>
              </li>
            </ul>
          </div>
