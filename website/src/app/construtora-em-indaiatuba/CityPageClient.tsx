        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-black">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32 w-full">
            <motion.div
              ...
              className="mb-8"
            >
              <Breadcrumbs items={[{ label: "Construtora em Indaiatuba" }]} />
            </motion.div>
              ...
              <div className="text-center">
                <FadeIn delay={0.1}>
                  <h1 className="text-white text-sm font-semibold tracking-[0.3em] uppercase mb-6">
                    Construtora de Casas Personalizadas em Indaiatuba
                  </h1>
                </FadeIn>
                ...
                <FadeIn delay={0.2}>
                  <h2 className="font-[var(--font-playfair)] text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-4">
                    Sua casa dos sonhos
                    <br />
                    <span className="text-[#000000] drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">em Indaiatuba</span>
                  </h2>
                </FadeIn>
            ...
            <div className="max-w-3xl mx-auto text-center mb-20">
              ...
              <FadeIn delay={0.2}>
                <p className="text-lg text-[#525252] leading-relaxed">
                  Indaiatuba possui um dos maiores IDHs do Brasil, segurança reconhecida e infraestrutura de primeiro nível. A Plenus é a construtora ideal para a sua casa aqui.
                </p>
              </FadeIn>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Cada casa nasce de uma conversa. Projetamos do zero para o seu estilo de vida e terreno.",
                },
                {
                  icon: (
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <FadeIn delay={0.1}>
                <h2 className="font-[var(--font-playfair)] text-3xl md:text-5xl font-bold text-white mb-6">
                  ...
                  <br />
                  <span className="text-white/50">em Indaiatuba?</span>
                </h2>
              </FadeIn>
              <FadeIn delay={0.2}>
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                  ...
                  <a
                    href="https://wa.me/5519992937486?text=Olá! Vim do site e gostaria de saber mais sobre construção em Indaiatuba."
                    target="_blank"
          ...
          <div className="border-t border-white/5">
            <div className="max-w-3xl mx-auto px-6 lg:px-8 py-12">
              <article className="text-sm text-white/30 space-y-3 leading-relaxed">
                ...
                <p>
                  A Construtora Plenus é referência em casas personalizadas em Indaiatuba, com experiência em condomínios como o Condomínio Milano. Terreno + construção com economia de até 40%.{" "}
                  ...
                  <Link href="/blog/quanto-custa-construir-casa-2026" className="text-white/50 underline underline-offset-2 hover:text-white/70 transition-colors">Quanto custa construir em 2026</Link>
                </p>
              </article>
            </div>
          </div>
